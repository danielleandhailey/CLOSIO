...
export const STAGE_COLORS = {
  'New Lead':      { bg: '#0ea5e9', text: '#fff', light: '#e0f2fe' },
  'HOT':           { bg: '#dc2626', text: '#fff', light: '#fee2e2' },
  'Updated':       { bg: '#059669', text: '#fff', light: '#d1fae5' },
  'Working':       { bg: '#2563eb', text: '#fff', light: '#dbeafe' },
  'Stips Needed':  { bg: '#d97706', text: '#fff', light: '#fef3c7' },
  'Credit Upgrade':{ bg: '#7c3aed', text: '#fff', light: '#ede9fe' },
  'Shopping':      { bg: '#16a34a', text: '#fff', light: '#dcfce7' },
  'Processing':    { bg: '#ea580c', text: '#fff', light: '#ffedd5' },
  'Funded':        { bg: '#059669', text: '#fff', light: '#d1fae5' },
  'Closed/Paid':   { bg: '#047857', text: '#fff', light: '#d1fae5' },
  'LP Ready':      { bg: '#7c3aed', text: '#fff', light: '#ede9fe' },
  'Paycom':        { bg: '#0891b2', text: '#fff', light: '#cffafe' },
  'Future Deal':   { bg: '#0d9488', text: '#fff', light: '#ccfbf1' },
  'DNQ':           { bg: '#4b5563', text: '#fff', light: '#e5e7eb' },
  'CXLD':          { bg: '#b91c1c', text: '#fff', light: '#fee2e2' },
  'Not Interested':       { bg: '#6b7280', text: '#fff', light: '#f3f4f6' },
...
export const STAGES_WITH_AUTO_TAGS = ["Processing", 'Funded', 'LP Ready', 'Paycom'];

export const STAGES_WITH_FULL_DETAILS = ["Processing", 'Funded', 'LP Ready', 'Paycom'];
