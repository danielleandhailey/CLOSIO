                ...
                return (
                  <div key={m.id} data-matrix-item={m.lender_name} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ...
                    >
                      ...
                      {(m.updated_at || m.created_at) && <div style={{ fontSize: '8px', color: '#4b5563' }}>{new Date(m.updated_at || m.created_at).toLocaleDateString('en-US', { month: 'numeric', day: 'numeric', year: '2-digit' })}</div>}
                    </a>
